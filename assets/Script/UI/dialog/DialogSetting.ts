...
export default class DialogSetting {
    ...
    private dialogBaseNode: cc.Node;
    ...
    constructor(baseNode: cc.Node, gameName: string) {
        ...
        this.dialogBaseNode = this.baseNode.getChildByName('dialog_setting');
 
        this.m_checkBox_sounds = this.dialogBaseNode.getChildByName('layout_content').getChildByName('item_sounds').getChildByName('btn_checkbox');
        this.m_checkBox_music = this.dialogBaseNode.getChildByName('layout_content').getChildByName('item_music').getChildByName('btn_checkbox');
        this.m_checkBox_vibration = this.dialogBaseNode.getChildByName('layout_content').getChildByName('item_vibration').getChildByName('btn_checkbox');
        this.m_checkBox_systemNotify = this.dialogBaseNode.getChildByName('layout_content').getChildByName('item_systemNotifications').getChildByName('btn_checkbox');
        this.m_checkBox_jackpotNotify = this.dialogBaseNode.getChildByName('layout_content').getChildByName('item_jackpotNotifications').getChildByName('btn_checkbox');
 
        this.m_btn_help = this.dialogBaseNode.getChildByName('layout_content').getChildByName('layout_container').getChildByName('mask').getChildByName('content').getChildByName('item_help');
        this.m_btn_rateUs = this.dialogBaseNode.getChildByName('layout_content').getChildByName('layout_container').getChildByName('mask').getChildByName('content').getChildByName('item_rateUs');
        this.m_btn_contactUs = this.dialogBaseNode.getChildByName('layout_content').getChildByName('layout_container').getChildByName('mask').getChildByName('content').getChildByName('item_contactUs');
        this.m_btn_Terms = this.dialogBaseNode.getChildByName('layout_content').getChildByName('layout_container').getChildByName('mask').getChildByName('content').getChildByName('item_terms');
        this.m_btn_privacyPollcy = this.dialogBaseNode.getChildByName('layout_content').getChildByName('layout_container').getChildByName('mask').getChildByName('content').getChildByName('item_privacyPollcy');
        this.m_btn_about = this.dialogBaseNode.getChildByName('layout_content').getChildByName('layout_container').getChildByName('mask').getChildByName('content').getChildByName('item_about');
 
        this.btnClose = this.dialogBaseNode.getChildByName('btn_close');
        this.initListener();
    }
