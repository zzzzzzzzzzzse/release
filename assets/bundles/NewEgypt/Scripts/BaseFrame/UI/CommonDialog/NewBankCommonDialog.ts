...
import ButtonEx from "../Component/NewBankButtonEx";
import NewBankDialogBase from "../Dialog/NewBankDialogBase";
import LanguageLabel from "../Language/NewBankLanguageLabel";
import LanguageRichText from "../Language/NewBankLanguageRichText";

const { ccclass, property } = cc._decorator;

@ccclass
export default class NewBankCommonDialog extends NewBankDialogBase {
    ...
    public onDestroy(): void {
        NewBankLogManager.instance.log(this.getData().popupKey + ' destroy');
        super.onDestroy();
    }
}
