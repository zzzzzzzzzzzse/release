...
import NewBankSpineFadeOut from "./NewBankSpineFadeOut";
import SpriteFadeOut from "./NewBankSpriteFadeOut";

const { ccclass, property, menu } = cc._decorator;

@ccclass
@menu('自定义组件/Mask/NewBankFadeOutMask')
export default class NewBankFadeOutMask extends NewBankComponentBase {
    @property(cc.Node)
    ...
    public updateFadeOutProp(): void {
        ...
        const spineFadeOutList = this.maskNode.getComponentsInChildren(NewBankSpineFadeOut);
