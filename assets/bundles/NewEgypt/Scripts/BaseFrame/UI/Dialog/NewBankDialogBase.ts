...
@ccclass
export default class NewBankDialogBase extends NewBankComponentBase {
    ...
    public open() {
        NewBankLogManager.instance.log("打开弹框:", this.path);
    ...
    */
    ...
    public close(isDestroy: boolean = true) {
        NewBankDialogManager.instance.closeDialog(this.getPath(), isDestroy);
    }
