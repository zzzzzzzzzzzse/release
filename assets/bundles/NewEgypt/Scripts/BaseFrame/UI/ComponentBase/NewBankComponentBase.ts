 ...
 */
@ccclass
export default class NewBankComponentBase extends cc.Component {
    ...
    public setInterval(callback: Function, interval: number = 0, repeat: number = null): number {
        let id = NewBankTimerManager.instance.setInterval(callback, interval, repeat);
    ...
    public clearInterval(id) {
        NewBankTimerManager.instance.clearInterval(id);
    }
    ...
    public setTimeOut(callback: Function, delay: number): number {
        let id = NewBankTimerManager.instance.setTimeOut(callback, delay);
    ...
    public clearTimeout(id: number) {
        NewBankTimerManager.instance.clearTimeout(id);
    }
