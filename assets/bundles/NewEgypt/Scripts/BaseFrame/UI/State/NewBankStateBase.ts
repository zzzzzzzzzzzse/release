...
export default class StateBase extends cc.Component {
    ...
    private addEvent() {
        NewBankSlotEventManager.instance.on(NewBankEventDefine.QUIE_CHANGE_NORMAL_STATE, this.changeNormalState, this);
        NewBankSlotEventManager.instance.on(NewBankEventDefine.QUIE_CHANGE_SPECIAL_STATE, this.changeSpecialState, this);
    }
