import { ViewCloseAnimType, ViewLevel, ViewOpenAnimType } from "../../Const/NewBankCommonDefine";
...
@ccclass
export default class NewBankViewBase extends NewBankComponentBase {
    @property
   ...
   */
    ...
    public close(closeAnimType: ViewCloseAnimType = ViewCloseAnimType.ONE,
        ...
        NewBankViewManager.instance.back(closeAnimType, openAnimType, isOpenLast);
    }
