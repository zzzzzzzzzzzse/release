...
import LanguageRichText from "../UI/Language/NewBankLanguageRichText";
import NewBankTimerManager from "./NewBankTimerManager";

export default class NewBankTipsManager {
    private static _instance: NewBankTipsManager = null;
    private tipsNode: cc.Node = null;

    /**
     * 获取单例
     */
    public static get instance(): NewBankTipsManager {
        if (!this._instance) {
            this._instance = new NewBankTipsManager();
        }
