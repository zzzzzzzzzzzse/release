...
let isOpen = CC_DEBUG;
@ccclass
export default class NewBankLogManager {
    private static _instance: NewBankLogManager;
    private logList: string[] = [];
    private maxCount: number = 1000;

    public static get instance() {
        if (NewBankLogManager._instance == null) {
            NewBankLogManager._instance = new NewBankLogManager();
        }
        return NewBankLogManager._instance;
    }
