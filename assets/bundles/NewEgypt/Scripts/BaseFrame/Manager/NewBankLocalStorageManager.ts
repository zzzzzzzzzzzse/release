...
export class NewBankLocalStorageManager {
    private static _instance: NewBankLocalStorageManager

    public static get instance() {
        if (NewBankLocalStorageManager._instance == null) {
            NewBankLocalStorageManager._instance = new NewBankLocalStorageManager();
        }
        return NewBankLocalStorageManager._instance;
    }
