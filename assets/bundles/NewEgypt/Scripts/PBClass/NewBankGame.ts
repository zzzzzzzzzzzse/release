...
//	S_C_STONEAGE_GAME_START_NOTIFY = 11500001;//通知游戏开始
export class NewBankGameStartNotify{
	public times: string;
...
//	C_S_STONEAGE_BET_REQUEST = 11500002;//游戏下注
export class NewBankBetRequest{
...
//	S_C_STONEAGE_BET_RESPONSE = 11500003;//游戏下注返回
export class NewBankBetResponse{
...
//	S_C_STONEAGE_GAME_OVER_NOTIFY = 11500004;//游戏结束通知
export class NewBankGameOverNotify{
	public times: string;
	public paytable: string;
	public totalPay: number;
	public free: number;
	public winType: number;
	public lineWin: Array<NewBankLineWin>;
	public gameType: number;
...
export class NewBankSyncNotify{
	public times: string;
