...
import { CommonTopStatus, OperateTypeEnum, PlayerVO, ServerVO } from "../BaseFrame/Const/NewBankCommonDefine";
...
export default class NewBankPlayerProxy {
    private static _instance: NewBankPlayerProxy = null;
     ...
     * 获取单例
     */
    public static get instance(): NewBankPlayerProxy {
        if (!this._instance) {
            this._instance = new NewBankPlayerProxy();
        }
    ...
    public setPlayerGold(gold: number, operateType: OperateTypeEnum): void {
        ...
        NewBankSlotEventManager.instance.emit(NewBankEventDefine.UPDATE_PLAYER_GOLD, { operateType: operateType });
    }
    ...
    public setPlayerInfo(playerInfo: any): void {
        ...
        NewBankSlotEventManager.instance.emit(NewBankEventDefine.USERINFO_CHANGED);
    }
    ...
    public setPlayerExpInfo(expInfo: any): void {
        ...
        NewBankSlotEventManager.instance.emit(NewBankEventDefine.UPDATE_PLAYER_EXPINFO);
        expInfo.levelUp && NewBankSlotEventManager.instance.emit(NewBankEventDefine.PLAYER_LEVEL_UP);
    }
    ...
    public setPlayerVipInfo(expInfo: any): void {
        ...
        NewBankSlotEventManager.instance.emit(NewBankEventDefine.UPDATE_PLAYER_VIPINFO);
        expInfo.levelUp && NewBankSlotEventManager.instance.emit(NewBankEventDefine.PLAYER_VIP_LEVEL_UP);
    }
    ...
    public setGameState(state: CommonTopStatus): void {
        ...
        NewBankSlotEventManager.instance.emit(NewBankEventDefine.GAME_STATE_CHANGED);
    }
