...
import { StoneAgeSoundsType } from "../StoneAgeDefine";

const { ccclass, property } = cc._decorator;

@ccclass
export default class StoneAgeFreeDialog extends StoneAgeDialogBase {
    @property(cc.Prefab)
    ...
    public onClose() {
        this._data.callback();
        // EventManager.instance.emit(StoneAgeEventDefine.FREE_DIALOG_CLOSE_CALLBACK);
    }
    ...
    public playFreeAnim() {
        StoneAgeSlotAudioManager.instance.playSound(BundleType.STONE_AGE, StoneAgeSoundsType.FREE_PRIZE);
