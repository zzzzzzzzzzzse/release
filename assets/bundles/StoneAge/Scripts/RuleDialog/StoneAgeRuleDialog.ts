...
import PageViewEx from "../BaseFrame/UI/Component/StoneAgePageViewEx";
import StoneAgeDialogBase from "../BaseFrame/UI/Dialog/StoneAgeDialogBase";

const { ccclass, property } = cc._decorator;

@ccclass
export default class StoneAgeRuleDialog extends StoneAgeDialogBase {
    @property(PageViewEx)
    ...
    public renderItem(item: cc.Node, idx: number) {
        // let tsStoneAgeRuleItem: StoneAgeRuleItem = <StoneAgeRuleItem>item.getComponent("StoneAgeRuleItem");
        // LogManager.instance.info("this.payTableArr:", this.payTableArr);
        // tsStoneAgeRuleItem.updateItem(this.payTableArr[idx]);
    ...
    private updateFooter(percent: number, index: number) {
        StoneAgeLogManager.instance.log("[StoneAgeRuleDialog] updateFooter:", percent, ",", index);
