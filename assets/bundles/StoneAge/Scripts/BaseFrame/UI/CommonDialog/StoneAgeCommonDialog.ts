...
import ButtonEx from "../Component/StoneAgeButtonEx";
import StoneAgeDialogBase from "../Dialog/StoneAgeDialogBase";
import LanguageLabel from "../Language/StoneAgeLanguageLabel";
import LanguageRichText from "../Language/StoneAgeLanguageRichText";

const { ccclass, property } = cc._decorator;

@ccclass
export default class StoneAgeCommonDialog extends StoneAgeDialogBase {
    ...
    public onDestroy(): void {
        StoneAgeLogManager.instance.log(this.getData().popupKey + ' destroy');
        super.onDestroy();
    }
}
