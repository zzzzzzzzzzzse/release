...
import StoneAgePageViewIndicatorItem from "./StoneAgePageViewIndicatorItem";
...
export default class StoneAgePageViewIndicator extends StoneAgeComponentBase {
    //模板类型
    ...
    public addItem(): void {
        StoneAgeLogManager.instance.log('增加一个页标');
    ...
    public setPages(pages: number): void {
        StoneAgeLogManager.instance.log('清空页标');
    ...
    public setCurrentPage(index: number = 0): void {
        ...
        for (let i = 0; i < this.itemList.length; i++) {
            ...
            const item = node.getComponent(StoneAgePageViewIndicatorItem);
