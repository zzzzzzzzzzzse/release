...
import StoneAgeSpineFadeOut from "./StoneAgeSpineFadeOut";
import SpriteFadeOut from "./StoneAgeSpriteFadeOut";

const { ccclass, property, menu } = cc._decorator;

@ccclass
@menu('自定义组件/Mask/StoneAgeFadeOutMask')
export default class StoneAgeFadeOutMask extends StoneAgeComponentBase {
    @property(cc.Node)
    ...
    public updateFadeOutProp(): void {
        ...
        const spineFadeOutList = this.maskNode.getComponentsInChildren(StoneAgeSpineFadeOut);
