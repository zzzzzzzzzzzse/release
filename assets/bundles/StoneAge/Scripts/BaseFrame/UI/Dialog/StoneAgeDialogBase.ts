...
@ccclass
export default class StoneAgeDialogBase extends StoneAgeComponentBase {
    ...
    public open() {
        StoneAgeLogManager.instance.log("打开弹框:", this.path);
    ...
    */
    ...
    public close(isDestroy: boolean = true) {
        StoneAgeDialogManager.instance.closeDialog(this.getPath(), isDestroy);
    }
