import { ViewCloseAnimType, ViewLevel, ViewOpenAnimType } from "../../Const/StoneAgeCommonDefine";
...
@ccclass
export default class StoneAgeViewBase extends StoneAgeComponentBase {
    @property
   ...
   */
    ...
    public close(closeAnimType: ViewCloseAnimType = ViewCloseAnimType.ONE,
        ...
        StoneAgeViewManager.instance.back(closeAnimType, openAnimType, isOpenLast);
    }
