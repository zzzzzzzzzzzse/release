...
export class StoneAgeSlotAudioManager {
    ...
    public static get instance() {
        if (StoneAgeSlotAudioManager._instance == null) {
            StoneAgeSlotAudioManager._instance = new StoneAgeSlotAudioManager();
        }
        return StoneAgeSlotAudioManager._instance;
    }
    ...
    private initLocalMusicConfig() {
        if (StoneAgeLocalStorageManager.instance.getLocalData(LocalStorageType.AUDIO_BGM_VOLUME) < 0
            || StoneAgeLocalStorageManager.instance.getLocalData(LocalStorageType.AUDIO_BGM_VOLUME) == "null"
            || StoneAgeLocalStorageManager.instance.getLocalData(LocalStorageType.AUDIO_BGM_VOLUME) == null) {
            StoneAgeLocalStorageManager.instance.saveLocalData(LocalStorageType.AUDIO_BGM_VOLUME, 0.5);
        }
        const musicSwitch = StoneAgeLocalStorageManager.instance.getLocalData(LocalStorageType.SWITCH_MUSIC);
        this._musicOpen = !musicSwitch || musicSwitch == '1';
    }

    private initLocalSoundConfig() {
        if (StoneAgeLocalStorageManager.instance.getLocalData(LocalStorageType.AUDIO_EFFECT_VOLUME) < 0
            || StoneAgeLocalStorageManager.instance.getLocalData(LocalStorageType.AUDIO_EFFECT_VOLUME) == "null"
            || StoneAgeLocalStorageManager.instance.getLocalData(LocalStorageType.AUDIO_EFFECT_VOLUME) == null) {
            StoneAgeLocalStorageManager.instance.saveLocalData(LocalStorageType.AUDIO_EFFECT_VOLUME, 1);
        }
        const soundSwitch = StoneAgeLocalStorageManager.instance.getLocalData(LocalStorageType.SWITCH_SOUND);
        this._soundOpen = !soundSwitch || soundSwitch == '1';
    }

    private getLocalMusicVolume() {
        return StoneAgeLocalStorageManager.instance.getLocalData(LocalStorageType.AUDIO_BGM_VOLUME);
    }

    private getLocalSoundVolume() {
        return StoneAgeLocalStorageManager.instance.getLocalData(LocalStorageType.AUDIO_EFFECT_VOLUME);
    }
    ...
    public setMusicVolume(value) {
        ...
        StoneAgeLocalStorageManager.instance.saveLocalData(LocalStorageType.AUDIO_BGM_VOLUME, this.musicVolume);
    }
    ...
    public setSoundVolume(value) {
        ...
        StoneAgeLocalStorageManager.instance.saveLocalData(LocalStorageType.AUDIO_EFFECT_VOLUME, this.soundVolume);
    }
    ...
    public stopSound(filePath) {
        StoneAgeLogManager.instance.info("停止播放音效：", filePath);
        StoneAgeLogManager.instance.info("当前音效列表：", this.soundMap);
    ...
    public set musicOpen(value: boolean) {
        ...
        StoneAgeLocalStorageManager.instance.saveLocalData(LocalStorageType.SWITCH_MUSIC, value ? '1' : '0');
        StoneAgeSlotEventManager.instance.emit(StoneAgeEventDefine.MUSIC_SWITCH);
    }
    ...
    public set soundOpen(value: boolean) {
        ...
        StoneAgeLocalStorageManager.instance.saveLocalData(LocalStorageType.SWITCH_SOUND, value ? '1' : '0');
    }
