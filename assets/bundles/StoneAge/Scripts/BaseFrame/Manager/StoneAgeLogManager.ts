...
let isOpen = CC_DEBUG;
@ccclass
export default class StoneAgeLogManager {
    private static _instance: StoneAgeLogManager;
    private logList: string[] = [];
    private maxCount: number = 1000;

    public static get instance() {
        if (StoneAgeLogManager._instance == null) {
            StoneAgeLogManager._instance = new StoneAgeLogManager();
        }
        return StoneAgeLogManager._instance;
    }
