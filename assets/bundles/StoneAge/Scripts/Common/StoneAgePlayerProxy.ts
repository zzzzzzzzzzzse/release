...
import { CommonTopStatus, OperateTypeEnum, PlayerVO, ServerVO } from "../BaseFrame/Const/StoneAgeCommonDefine";
...
export default class StoneAgePlayerProxy {
    private static _instance: StoneAgePlayerProxy = null;
     ...
     * 获取单例
     */
    public static get instance(): StoneAgePlayerProxy {
        if (!this._instance) {
            this._instance = new StoneAgePlayerProxy();
        }
    ...
    public setPlayerGold(gold: number, operateType: OperateTypeEnum): void {
        ...
        StoneAgeSlotEventManager.instance.emit(StoneAgeEventDefine.UPDATE_PLAYER_GOLD, { operateType: operateType });
    }
    ...
    public setPlayerInfo(playerInfo: any): void {
        ...
        StoneAgeSlotEventManager.instance.emit(StoneAgeEventDefine.USERINFO_CHANGED);
    }
    ...
    public setPlayerExpInfo(expInfo: any): void {
        ...
        StoneAgeSlotEventManager.instance.emit(StoneAgeEventDefine.UPDATE_PLAYER_EXPINFO);
        expInfo.levelUp && StoneAgeSlotEventManager.instance.emit(StoneAgeEventDefine.PLAYER_LEVEL_UP);
    }
    ...
    public setPlayerVipInfo(expInfo: any): void {
        ...
        StoneAgeSlotEventManager.instance.emit(StoneAgeEventDefine.UPDATE_PLAYER_VIPINFO);
        expInfo.levelUp && StoneAgeSlotEventManager.instance.emit(StoneAgeEventDefine.PLAYER_VIP_LEVEL_UP);
    }
    ...
    public setGameState(state: CommonTopStatus): void {
        ...
        StoneAgeSlotEventManager.instance.emit(StoneAgeEventDefine.GAME_STATE_CHANGED);
    }
