...
import { CommonTopStatus, OperateTypeEnum, PlayerVO, ServerVO } from "../BaseFrame/Const/RichCommonDefine";
...
export default class RichPlayerProxy {
    private static _instance: RichPlayerProxy = null;
     ...
     * 获取单例
     */
    public static get instance(): RichPlayerProxy {
        if (!this._instance) {
            this._instance = new RichPlayerProxy();
        }
    ...
    public setPlayerGold(gold: number, operateType: OperateTypeEnum): void {
        ...
        RichSlotEventManager.instance.emit(RichEventDefine.UPDATE_PLAYER_GOLD, { operateType: operateType });
    }
    ...
    public setPlayerInfo(playerInfo: any): void {
        ...
        RichSlotEventManager.instance.emit(RichEventDefine.USERINFO_CHANGED);
    }
    ...
    public setPlayerExpInfo(expInfo: any): void {
        ...
        RichSlotEventManager.instance.emit(RichEventDefine.UPDATE_PLAYER_EXPINFO);
        expInfo.levelUp && RichSlotEventManager.instance.emit(RichEventDefine.PLAYER_LEVEL_UP);
    }
    ...
    public setPlayerVipInfo(expInfo: any): void {
        ...
        RichSlotEventManager.instance.emit(RichEventDefine.UPDATE_PLAYER_VIPINFO);
        expInfo.levelUp && RichSlotEventManager.instance.emit(RichEventDefine.PLAYER_VIP_LEVEL_UP);
    }
    ...
    public setGameState(state: CommonTopStatus): void {
        ...
        RichSlotEventManager.instance.emit(RichEventDefine.GAME_STATE_CHANGED);
    }
