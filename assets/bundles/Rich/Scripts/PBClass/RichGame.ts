...
//	S_C_STONEAGE_GAME_START_NOTIFY = 11500001;//通知游戏开始
export class RichGameStartNotify{
	public times: string;
...
//	S_C_STONEAGE_GAME_OVER_NOTIFY = 11500004;//游戏结束通知
export class RichGameOverNotify{
	public times: string;
	public paytable: string;
	public totalPay: number;
	public free: number;
	public winType: number;
	public lineWin: Array<RichLineWin>;
	public gameType: number;
