...
export default class StateBase extends cc.Component {
    ...
    private addEvent() {
        RichSlotEventManager.instance.on(RichEventDefine.QUIE_CHANGE_NORMAL_STATE, this.changeNormalState, this);
        RichSlotEventManager.instance.on(RichEventDefine.QUIE_CHANGE_SPECIAL_STATE, this.changeSpecialState, this);
    }
