...
@ccclass
@menu('自定义组件/RichLabelStroke')
export default class RichLabelStroke extends RichComponentBase {
    @property(cc.Color)
    ...
    protected onLoad(): void {
        ...
        if (!label) {
            RichLogManager.instance.warn('请把LabelStroke挂在label组件下');
            return;
        }
        ...
        strokeLabelNode.removeComponent(RichLabelStroke);
