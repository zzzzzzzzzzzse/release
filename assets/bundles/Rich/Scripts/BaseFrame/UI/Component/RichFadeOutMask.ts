...
import RichSpineFadeOut from "./RichSpineFadeOut";
import SpriteFadeOut from "./RichSpriteFadeOut";

const { ccclass, property, menu } = cc._decorator;

@ccclass
@menu('自定义组件/Mask/RichFadeOutMask')
export default class RichFadeOutMask extends RichComponentBase {
    @property(cc.Node)
    ...
    public updateFadeOutProp(): void {
        ...
        const spineFadeOutList = this.maskNode.getComponentsInChildren(RichSpineFadeOut);
