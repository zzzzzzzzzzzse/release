import RichCircleScrollItem from "./RichCircleScrollItem";
...
export default class RichCircleScroll extends cc.Component {
    ...
    private createItem(index: number, isRight: boolean = true): void {
        ...
        if (!nodeInfo) {
            ...
            const node = cc.instantiate(this.itemPrefab);
            const circleScrollItem = node.getComponent(RichCircleScrollItem);
