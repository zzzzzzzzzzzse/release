import { ViewCloseAnimType, ViewLevel, ViewOpenAnimType } from "../../Const/RichCommonDefine";
...
@ccclass
export default class RichViewBase extends RichComponentBase {
    @property
   ...
   */
    ...
    public close(closeAnimType: ViewCloseAnimType = ViewCloseAnimType.ONE,
        ...
        RichViewManager.instance.back(closeAnimType, openAnimType, isOpenLast);
    }
