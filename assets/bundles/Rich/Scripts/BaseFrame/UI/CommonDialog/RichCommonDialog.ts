...
import ButtonEx from "../Component/RichButtonEx";
...
@ccclass
export default class RichCommonDialog extends RichDialogBase {
    ...
    public onDestroy(): void {
        RichLogManager.instance.log(this.getData().popupKey + ' destroy');
        super.onDestroy();
    }
}
