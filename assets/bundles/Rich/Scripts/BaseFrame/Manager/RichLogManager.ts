...
let isOpen = CC_DEBUG;
@ccclass
export default class RichLogManager {
    private static _instance: RichLogManager;
    private logList: string[] = [];
    private maxCount: number = 1000;

    public static get instance() {
        if (RichLogManager._instance == null) {
            RichLogManager._instance = new RichLogManager();
        }
        return RichLogManager._instance;
    }
