...
export default class StateBase extends cc.Component {
    ...
    private addEvent() {
        PoseidonSlotEventManager.instance.on(PoseidonEventDefine.QUIE_CHANGE_NORMAL_STATE, this.changeNormalState, this);
        PoseidonSlotEventManager.instance.on(PoseidonEventDefine.QUIE_CHANGE_SPECIAL_STATE, this.changeSpecialState, this);
    }
