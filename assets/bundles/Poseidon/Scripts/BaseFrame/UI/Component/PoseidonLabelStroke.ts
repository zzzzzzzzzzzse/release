...
@ccclass
@menu('自定义组件/PoseidonLabelStroke')
export default class PoseidonLabelStroke extends PoseidonComponentBase {
    @property(cc.Color)
    ...
    protected onLoad(): void {
        ...
        if (!label) {
            PoseidonLogManager.instance.warn('请把LabelStroke挂在label组件下');
            return;
        }
        ...
        strokeLabelNode.removeComponent(PoseidonLabelStroke);
