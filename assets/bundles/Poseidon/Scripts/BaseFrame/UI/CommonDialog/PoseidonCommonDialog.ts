...
import ButtonEx from "../Component/PoseidonButtonEx";
import PoseidonDialogBase from "../Dialog/PoseidonDialogBase";
import LanguageLabel from "../Language/PoseidonLanguageLabel";
import LanguageRichText from "../Language/PoseidonLanguageRichText";

const { ccclass, property } = cc._decorator;

@ccclass
export default class PoseidonCommonDialog extends PoseidonDialogBase {
    ...
    public onDestroy(): void {
        PoseidonLogManager.instance.log(this.getData().popupKey + ' destroy');
        super.onDestroy();
    }
}
