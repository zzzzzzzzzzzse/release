...
@ccclass
export default class PoseidonDialogBase extends PoseidonComponentBase {
    ...
    public open() {
        PoseidonLogManager.instance.log("打开弹框:", this.path);
    ...
    */
    ...
    public close(isDestroy: boolean = true) {
        PoseidonDialogManager.instance.closeDialog(this.getPath(), isDestroy);
    }
