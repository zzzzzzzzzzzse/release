 ...
 */
@ccclass
export default class PoseidonComponentBase extends cc.Component {
    ...
    public setInterval(callback: Function, interval: number = 0, repeat: number = null): number {
        let id = PoseidonTimerManager.instance.setInterval(callback, interval, repeat);
    ...
    public clearInterval(id) {
        PoseidonTimerManager.instance.clearInterval(id);
    }
    ...
    public setTimeOut(callback: Function, delay: number): number {
        let id = PoseidonTimerManager.instance.setTimeOut(callback, delay);
    ...
    public clearTimeout(id: number) {
        PoseidonTimerManager.instance.clearTimeout(id);
    }
