import { ViewCloseAnimType, ViewLevel, ViewOpenAnimType } from "../../Const/PoseidonCommonDefine";
...
@ccclass
export default class PoseidonViewBase extends PoseidonComponentBase {
    @property
   ...
   */
    ...
    public close(closeAnimType: ViewCloseAnimType = ViewCloseAnimType.ONE,
        ...
        PoseidonViewManager.instance.back(closeAnimType, openAnimType, isOpenLast);
    }
