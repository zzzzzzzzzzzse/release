...
export default class PoseidonFacebookSdk {
    private static _instance: PoseidonFacebookSdk = null;
     ...
     * 获取单例
     */
    public static get instance(): PoseidonFacebookSdk {
        if (!this._instance) {
            this._instance = new PoseidonFacebookSdk();
        }
    ...
    private loginCallback(resultStr: any): void {
        ...
        this.token = token;
        PoseidonSlotEventManager.instance.emit(PoseidonEventDefine.FACEBOOK_LOGIN_SUCCESS);
    }
