...
export default abstract class PoseidonProtocolBase {
    ...
    public async encode(data: any, msgName: string, needLog: boolean = true): Promise<any> {
        ...
        if (!this.pb || !this.pb[msgName]) {
            PoseidonLogManager.instance.log(msgName + '协议未定义');
        }
        ...
        needLog && PoseidonLogManager.instance.log('send===============' + msgName + '===============', data);
    ...
    public async decode(buffer: any, msgName: string, needLog: boolean = true) {
        ...
        needLog && PoseidonLogManager.instance.log('recv===============' + msgName + '===============', data);
        return data;
    }
