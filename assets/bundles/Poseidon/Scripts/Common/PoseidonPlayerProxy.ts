...
import { CommonTopStatus, OperateTypeEnum, PlayerVO, ServerVO } from "../BaseFrame/Const/PoseidonCommonDefine";
...
export default class PoseidonPlayerProxy {
    private static _instance: PoseidonPlayerProxy = null;
     ...
     * 获取单例
     */
    public static get instance(): PoseidonPlayerProxy {
        if (!this._instance) {
            this._instance = new PoseidonPlayerProxy();
        }
    ...
    public setPlayerGold(gold: number, operateType: OperateTypeEnum): void {
        ...
        PoseidonSlotEventManager.instance.emit(PoseidonEventDefine.UPDATE_PLAYER_GOLD, { operateType: operateType });
    }
    ...
    public setPlayerInfo(playerInfo: any): void {
        ...
        PoseidonSlotEventManager.instance.emit(PoseidonEventDefine.USERINFO_CHANGED);
    }
    ...
    public setPlayerExpInfo(expInfo: any): void {
        ...
        PoseidonSlotEventManager.instance.emit(PoseidonEventDefine.UPDATE_PLAYER_EXPINFO);
        expInfo.levelUp && PoseidonSlotEventManager.instance.emit(PoseidonEventDefine.PLAYER_LEVEL_UP);
    }
    ...
    public setPlayerVipInfo(expInfo: any): void {
        ...
        PoseidonSlotEventManager.instance.emit(PoseidonEventDefine.UPDATE_PLAYER_VIPINFO);
        expInfo.levelUp && PoseidonSlotEventManager.instance.emit(PoseidonEventDefine.PLAYER_VIP_LEVEL_UP);
    }
    ...
    public setGameState(state: CommonTopStatus): void {
        ...
        PoseidonSlotEventManager.instance.emit(PoseidonEventDefine.GAME_STATE_CHANGED);
    }
