...
export default class ScrollViewPlus extends cc.ScrollView {
    ...
    public optDc(callback?:Function) {
        ScrollViewPlus.optDc(this, this.caculatePosition,callback);
    }
     ...
     */
    public static optDc(scrollView: cc.ScrollView, caculatePosition: boolean,callback?:Function) {
