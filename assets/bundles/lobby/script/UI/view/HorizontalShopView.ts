 ...
 */
@ccclass
export default class HorizontalShopView extends cc.Component {
    ...
    private initView() {
        ...
        this.m_shop = this.node.getChildByName('layout_top').getChildByName('btn_shop');
        this.m_diamonds = this.node.getChildByName('layout_top').getChildByName('user_diamonds');
        this.m_chips = this.node.getChildByName('layout_top').getChildByName('user_chips');
