...
export default abstract class ChristmasProtocolBase {
    ...
    public async encode(data: any, msgName: string, needLog: boolean = true): Promise<any> {
        ...
        if (!this.pb || !this.pb[msgName]) {
            ChristmasLogManager.instance.log(msgName + '协议未定义');
        }
        ...
        needLog && ChristmasLogManager.instance.log('send===============' + msgName + '===============', data);
    ...
    public async decode(buffer: any, msgName: string, needLog: boolean = true) {
        ...
        needLog && ChristmasLogManager.instance.log('recv===============' + msgName + '===============', data);
        return data;
    }
