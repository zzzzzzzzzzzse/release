...
let isOpen = CC_DEBUG;
@ccclass
export default class ChristmasLogManager {
    private static _instance: ChristmasLogManager;
    private logList: string[] = [];
    private maxCount: number = 1000;

    public static get instance() {
        if (ChristmasLogManager._instance == null) {
            ChristmasLogManager._instance = new ChristmasLogManager();
        }
        return ChristmasLogManager._instance;
    }
