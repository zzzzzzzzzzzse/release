...
import LanguageRichText from "../UI/Language/ChristmasLanguageRichText";
import ChristmasTimerManager from "./ChristmasTimerManager";

export default class ChristmasTipsManager {
    private static _instance: ChristmasTipsManager = null;
    private tipsNode: cc.Node = null;

    /**
     * 获取单例
     */
    public static get instance(): ChristmasTipsManager {
        if (!this._instance) {
            this._instance = new ChristmasTipsManager();
        }
