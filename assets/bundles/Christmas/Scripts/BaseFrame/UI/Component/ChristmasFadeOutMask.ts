...
import ChristmasSpineFadeOut from "./ChristmasSpineFadeOut";
import SpriteFadeOut from "./ChristmasSpriteFadeOut";

const { ccclass, property, menu } = cc._decorator;

@ccclass
@menu('自定义组件/Mask/ChristmasFadeOutMask')
export default class ChristmasFadeOutMask extends ChristmasComponentBase {
    @property(cc.Node)
    ...
    public updateFadeOutProp(): void {
        ...
        const spineFadeOutList = this.maskNode.getComponentsInChildren(ChristmasSpineFadeOut);
