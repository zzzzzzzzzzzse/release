...
@ccclass
export default class ChristmasDialogBase extends ChristmasComponentBase {
    ...
    public open() {
        ChristmasLogManager.instance.log("打开弹框:", this.path);
    ...
    */
    ...
    public close(isDestroy: boolean = true) {
        ChristmasDialogManager.instance.closeDialog(this.getPath(), isDestroy);
    }
