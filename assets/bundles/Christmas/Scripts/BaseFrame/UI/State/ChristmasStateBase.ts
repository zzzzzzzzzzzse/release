...
export default class StateBase extends cc.Component {
    ...
    private addEvent() {
        ChristmasSlotEventManager.instance.on(ChristmasEventDefine.QUIE_CHANGE_NORMAL_STATE, this.changeNormalState, this);
        ChristmasSlotEventManager.instance.on(ChristmasEventDefine.QUIE_CHANGE_SPECIAL_STATE, this.changeSpecialState, this);
    }
