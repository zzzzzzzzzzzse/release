...
@ccclass
export default class ChristmasUtil {
    ...
    */
    ...
    public static printErrorCode(errorCode: number): void {
        const str = ChristmasLanguageManager.instance.getLanguageStringById('' + errorCode);
        if (!str) {
            ChristmasTipsManager.instance.showTips(errorCode + 'Error code is not defined');
            return;
        }
        ChristmasTipsManager.instance.showTips(str);
    }
    ...
    public static setServerTime(timeStamp: number): void {
        ...
        this.timer = ChristmasTimerManager.instance.setTimeOut(() => {
