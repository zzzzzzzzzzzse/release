...
import { ChristmasSoundsType } from "../ChristmasDefine";

const { ccclass, property } = cc._decorator;

@ccclass
export default class ChristmasFreeDialog extends ChristmasDialogBase {
    @property(cc.Prefab)
    ...
    public onClose() {
        this._data.callback();
        // EventManager.instance.emit(ChristmasEventDefine.FREE_DIALOG_CLOSE_CALLBACK);
    }
    ...
    public playFreeAnim() {
        ChristmasSlotAudioManager.instance.playSound(BundleType.STONE_AGE, ChristmasSoundsType.FREE_PRIZE);
